...
func init() {
	...
	operatorDeleteCmd.Flags().BoolVar(&operatorDeleteOptions.KeepOceanCdCrds, "keep-crds", true, "Should we keep OceanCD crds")
	...
	operatorDeleteCmd.Flags().BoolVar(&operatorDeleteOptions.KeepNamespace, "keep-namespace", false, "Should we keep OceanCD namespace")
}
...
func deleteOperator(ctx context.Context) error {
	...
	if err = deleteClusterManifests(ctx, operatorDeleteOptions.Namespace, manifestsToDelete.Operator, operatorDeleteOptions.KeepOceanCdCrds, true); err != nil {
	...
	if err = deleteClusterManifests(ctx, operatorDeleteOptions.Namespace, manifestsToDelete.OM, false, operatorDeleteOptions.KeepNamespace); err != nil {
